...
<body>
    <div class="login-wrapper">
        ...
        <form class="login-form" action="{{ route('etudiantlogin.submit') }}" method="POST">
            @csrf

            <div class="login-form-group">
                <label for="identifiant" class="login-label">Identifiant</label>
                <input type="text" id="identifiant" name="identifiant" class="login-input" required placeholder="Entrez votre identifiant">
            </div>
        ...
        <div class="login-footer-links">
            ...
            <a href="#" class="login-register-link">S'inscrire</a>
        </div>
    </div>
</body>
</html>
